...
class TrainVQGAN:
    def __init__(self, args, user_id, total_far, total_frr, total_err, total_f1, total_auc, x_train, y_train, x_valid, y_valid, subjects):
        ...
        '''
        self.vqgan.load_checkpoint('./checkpoints/vqgan_epoch_0.pt')
...
if __name__ == '__main__':
    ...
    for i in tqdm(range(10), desc="total user"):
        ...
        user_id = i
        train_vqgan = TrainVQGAN(args, user_id, total_far, total_frr, total_err, total_f1, total_auc, x_train, y_train, x_valid, y_valid, subjects)
