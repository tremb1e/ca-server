...
class Discriminator(nn.Module):
    def __init__(self, args, num_filters_last=64, n_layers=3):
        ...
        layers = [nn.Conv2d(args.image_channels, num_filters_last, 3, 2, 1), nn.LeakyReLU(0.2)]
        num_filters_mult = 1
        ...
        for i in range(1, n_layers + 1):
            ...
            layers += [
                nn.Conv2d(num_filters_last * num_filters_mult_last, num_filters_last * num_filters_mult, 3,
